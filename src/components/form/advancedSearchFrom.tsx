 ...
 * @Date: 2023-03-16 17:58:26
 * @LastEditors: duxinyues yongyuan253015@gmail.com
 * @LastEditTime: 2023-03-16 18:07:10
 * @FilePath: \vite-react\src\components\form\advancedSearchFrom.tsx
 * @Description:
...
function AdvancedSearchFrom(props: Props) {
  const {
    formLayout,
    formItems,
    values,
  ...
  return (
    <div className="SearchForm" style={style}>
      ...
      >
        {btnStatus
          ? renderFormItems(
              expandStatus ? formItems : formItems.slice(0, rows),
              formDisabled
            )
      ...
      {!hideBtn && (
        ...
        >
          <Space size={12}>
            ...
            {btnList?.map(({ style, onClick, text }: any) => (
              <Button
                size="small"
                type="primary"
                style={style}
            ...
            {formItems?.length > rows && btnStatus && (
              <div>
                {expandStatus ? (
                  <Button
                    type="link"
