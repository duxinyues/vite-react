 ...
 * @Date: 2023-03-02 17:12:37
 * @LastEditors: duxinyues yongyuan253015@gmail.com
 * @LastEditTime: 2023-03-02 17:17:23
 * @FilePath: \vite-react\src\views\dataScreen\components\AnnualPhysicalChart.tsx
 * @Description: 
 * Copyright (c) 2023 by ${duxinyues} email: ${yongyuan253015@gmail.com}, All Rights Reserved.
 */
import { useEcharts } from "@/hooks/useEcharts";
import { EChartsOption } from "echarts";
import "./AnnualPhysicalChart.scss";
interface ChartProp {
	label: string;
	value: string[];
}

const AnnualPhysicalChart = () => {
...
export default AnnualPhysicalChart;
