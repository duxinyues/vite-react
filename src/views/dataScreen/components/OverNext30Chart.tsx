 ...
 * @Date: 2023-03-02 14:17:48
 * @LastEditors: duxinyues yongyuan253015@gmail.com
 * @LastEditTime: 2023-03-02 16:02:41
 * @FilePath: \vite-react\src\views\dataScreen\components\OverNext30Chart.tsx
 * @Description:
...
function OverNext30Chart({
  ...
  const option: EChartsOption = {
    ...
    yAxis: unit.map((val: string, index: number) => {
      return {
        name: "(下单量)",
        nameTextStyle: {
          color: "#7ec7ff",
